...
function squares(p) {
    ...
    const folders = [
        ...
        'church/11/', 'church/12/', 'church/14/', 'church/15/',
        'church/17/', 'church/18/', 'church/19/', 'church/20/',
        'church/21/', 'church/22/', 'church/24/', 'church/26/',
        // Add 'church/30/' multiple times to increase its likelihood
        'church/31/', 'church/31/','church/31/', 'church/31/',
        'church/32/',
        ...
        'church/41/','church/41/','church/41/',
        'church/42/','church/42/','church/42/',
        'church/43/','church/43/','church/43/',
        'church/44/','church/44/','church/44/',
        'church/45/','church/45/','church/45/',
        'church/46/','church/46/','church/46/','church/46/','church/46/','church/46/','church/46/',
        'church/47/',  'church/47/',  'church/47/',
        'church/48/','church/48/','church/48/',
        'church/49/','church/49/','church/49/'
